...
if ($loggedIn) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$response) {
            ...
            $moduli = json_decode($response, true);
        ...
        $ch = curl_init();
        $url = 'http://localhost/P002_SmartCommunication/serverRest.php/?action=printMod';
...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex align-items-center mx-auto" style="max-width: 600px;" method="POST" action="moduli.php"> <!-- aggiungi action se necessario -->
                ...
                <select class="form-select me-2" aria-label="Filtra per" name="filterBy">
                    ...
                    <option value="id_modulo">Nome</option>
...
<table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
          <td onclick="window.location.href='moduloDetail.php?id=<?php echo $modulo['id_modulo']; ?>';">
              <?php echo htmlspecialchars($modulo['id_modulo']); ?>
          </td>

...
if ($loggedIn) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ch = curl_init();
        $url = 'http://localhost/P002_SmartCommunication/serverRest.php/?action=printCirc';
...
<meta charset="UTF-8">
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
          // MDB init here if necessary
          // new mdb.Dropdown(...) if needed
...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex align-items-center mx-auto" style="max-width: 600px;" method="POST" action="circolari.php"> <!-- aggiungi action se necessario -->

...
if ($loggedIn) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ch = curl_init();
        $url = 'http://localhost/P002_SmartCommunication/serverRest.php/?action=visualizzati';
...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex align-items-center mx-auto" style="max-width: 600px;" method="POST" action="visualizzati.php"> <!-- aggiungi action se necessario -->
...
<!-- Navbar -->
  ...
  <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr onclick="window.location.href='circolareDetail.php?id=<?php echo $circolare['id_circolare']; ?>';">
            <td><?php echo htmlspecialchars($circolare['id_circolare']); ?></td>
            <td><?php echo htmlspecialchars($circolare['categoria_circolare']); ?></td>
            <td><?php echo htmlspecialchars($circolare['data_circolare']); ?></td>
        </tr>
        <?php endforeach; ?>
      </tbody>
  </table>

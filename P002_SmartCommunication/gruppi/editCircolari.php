...
if ($loggedIn) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ch = curl_init();
        $url = 'http://localhost/P002_SmartCommunication/serverRest.php?action=getAllCirc&id='.$_GET['id'];
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
...
<meta charset="UTF-8">
    ...
    <script>
      ...
      function aggiungiCircolareAlGruppo(idCircolare, idGruppo) {
            var xhr = new XMLHttpRequest();
            xhr.open('PUT', 'http://localhost/P002_SmartCommunication/serverRest.php?action=addCirc', true);
            ...
            xhr.send(JSON.stringify({ id_circolare: idCircolare, id_gruppo: idGruppo }));
        }
...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex align-items-center mx-auto" style="max-width: 600px;" method="POST" action="editCircolari.php?id=<?php echo $_GET['id']?>"> <!-- aggiungi action se necessario -->
...
<table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
          ...
          <td>
          <a href="javascript:void(0)" onclick="aggiungiCircolareAlGruppo('<?php echo $circolare['id_circolare']; ?>', '<?php echo $_GET['id']; ?>')" class="add-button" title="Aggiungi circolare"><i class="fas fa-plus"></i></a>
</td>
      </tr>
      <?php endforeach; ?>
    </tbody>
